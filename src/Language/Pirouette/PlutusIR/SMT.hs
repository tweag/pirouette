...
trPIRFun P.ModInteger [x, y] = Just $ SimpleSMT.mod x y
...
-- If then else
trPIRFun P.IfThenElse _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
trPIRFun P.ChooseUnit _ = error "Not implemented: PIR builtin function"
-- Lists and pairs
trPIRFun P.Trace x = Just (SimpleSMT.List x)
trPIRFun P.FstPair _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
trPIRFun P.SndPair _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
trPIRFun P.ChooseList _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
trPIRFun P.MkCons _ = error "Not implemented: PIR builtin function"
trPIRFun P.HeadList _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
trPIRFun P.TailList _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
trPIRFun P.NullList _ = error "Not implemented: PIR builtin function"
-- Data
trPIRFun P.ChooseData _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
...
trPIRFun P.UnConstrData _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
...
trPIRFun P.UnIData _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
trPIRFun P.UnBData _ = error "Not implemented: PIR builtin function" -- TODO REQUIRED BY "AUCTION"
