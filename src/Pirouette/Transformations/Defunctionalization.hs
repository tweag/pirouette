...
defunTypes :: (PrettyLang lang, LanguageBuiltins lang)
           => PrtUnorderedDefs lang
...
defunDtors :: forall lang. (PrettyLang lang, LanguageBuiltins lang)
           => PrtUnorderedDefs lang
           -> PrtUnorderedDefs lang
...
defunFuns :: (PrettyLang lang, Pretty (FunDef lang), LanguageBuiltins lang)
          => PrtUnorderedDefs lang
          -> DefunCallsCtx lang (PrtUnorderedDefs lang)
...
mkClosureTypes :: (PrettyLang lang, LanguageBuiltins lang) => [ClosureCtorInfo lang] -> Decls lang
...
mkApplyFuns :: (PrettyLang lang, LanguageBuiltins lang) => [ClosureCtorInfo lang] -> Decls lang
...
mkClosureArg :: (PrettyLang lang, LanguageBuiltins lang)
...
closureTypeName :: (PrettyLang lang, LanguageBuiltins lang) => B.Type lang -> Name
closureTypeName ty = [i|Closure[#{funTyStr ty}]|]

applyFunName :: (PrettyLang lang, LanguageBuiltins lang) => B.Type lang -> Name
applyFunName ty = [i|Apply[#{funTyStr ty}]|]

closureType :: (PrettyLang lang, LanguageBuiltins lang) => B.Type lang -> B.Type lang
